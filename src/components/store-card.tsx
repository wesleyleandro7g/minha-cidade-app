    ...
    <YStack key={id} flex={1} h='$15' bg='$white' br='$6'>
      ...
      <YStack flex={1} px='$2.5' pb='$2.5' jc='space-between'>
        <Circle size='$6' borderWidth='$0.5' borderColor='$white' mt='$-6'>
          <Image source={logo} w='100%' h='100%' br='$12' resizeMode='cover' />
        </Circle>
        <YStack>
          <Text fontWeight='700' fontSize='$4' color='$gray' numberOfLines={1}>
            {name}
          </Text>
          <Text fontWeight='500' fontSize='$2' color='$slate' numberOfLines={2}>
            {description}
          </Text>
        </YStack>
